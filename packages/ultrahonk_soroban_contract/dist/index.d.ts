...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CCBDMYDBPMYDOSZNC7LWBTYVOTMZK3XZF3N2RABGMZFK4A5MYR7BJBBC";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        verify_proof: (json: string) => AssembledTransaction<Result<Buffer<ArrayBufferLike>, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        set_vk: (json: string) => AssembledTransaction<Result<Buffer<ArrayBufferLike>, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        verify_proof_with_stored_vk: (json: string) => AssembledTransaction<Result<Buffer<ArrayBufferLike>, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
